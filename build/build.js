	...
	var MainBox = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var items = data.map(function (item) {
	            return React.createElement(_finditem2.default, { itemdata: item, noHeader: 'true' });
	        });
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'li',
	                                { className: 'pic_list' },
	                                React.createElement('img', { src: 'http://cdnimg2.edu.euming.com/pkuie/2016/07/01/s_1467341666604_7O6Vrh.jpg' })
	                            )
	                        )
	                    )
	                )
